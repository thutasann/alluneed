...
class ProductController extends Controller
{
   ...
   public function index()
   {
        ...
        $trash = Products::where('status', '3')->get();
   ...
   public function store(Request $request)
   {
       ...
       {
          return redirect()->back()->with('status_img', 'Please Choose Image');
       }
   ...
   public function edit($id)
   {
      ...
      $products = Products::find($decrypted);
          ...
          return view('admin.collection.product.edit')->with('products',$products)
                                                       ->with('subcategory',$subcategory);
   }
   ...
   public function update(Request $request, $id)
   {
       ...
       if($request->hasfile('prod_image'))
       {    
            $filepath_image = 'uploads/products/'.$products->prod_image;
   ...
   public function deletedrestore($id)
   {
      ...
      $product->status = "0";
      $product->update();
      return redirect('products')->with('status', 'Product Restored Successfully');
   }
