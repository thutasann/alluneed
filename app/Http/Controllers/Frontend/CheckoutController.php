...
class CheckoutController extends Controller
{
    ...
    private function update_user_stripe($user_id, Request $request)
    {
        ...
        $user->Iname = $request->input('s_Iname');
    ...
    public function storeorderstripe(Request $request)
    {
        if (isset($_POST['stipe_payment_btn'])) {
            ...
            $STRIPE_SECRET = "sk_test_51I0h7qCb7kjLKG1BEUfvwi3qLgIbAcsUzpqUgMA06Y7cbEQYLNJlMwgOnKsIAzzvxOy10Y2K3ibNqcf15fP3X2r5004gheq7gd";
            Stripe::setApiKey($STRIPE_SECRET);
            \Stripe\Charge::create([
                'amount' => $total * 100,
                'currency' => 'usd',
                'description' => "Thank you for purchasing with AllUNeed",
                'source' => $stripetoken,
                'shipping' =>
                [
                    'name' => Auth::user()->name,
