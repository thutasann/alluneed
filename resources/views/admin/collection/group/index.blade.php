                            ...
                            <table class='table table-striped table-bordered' id='datatable'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('group-edit/'.$encrypted.'/'.$slname )}}" title="Edit" class="badge badge-pill text-white px-2 py-1 bg-gradient-primary">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ url('group-delete/'.$encrypted) }}" title="Trash" class="badge badge-pill text-white px-2 py-1 bg-gradient-danger">
