        ...
        <div class="card mb-4 shadow-sm bg-gray-100 border-left-primary">
            <div class="card-body d-sm-flex align-items-center justify-content-between">
                ...
                <span>
                    @if(count($products) == 0)
                    @else
                        <a href="{{ url('empty-product-trash') }}" class='btn btn-sm bg-gradient-danger p-1 text-white'>
                            ...
                            <table class='table table-striped table-bordered' id='datatable'>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('product-re-store/' .$encrypted) }}" title="Restore" class="mr-1 badge badge-pill text-white px-2 py-1 bg-gradient-success">
                                                <i class="fas fa-trash-restore-alt"></i>
                                            </a>
                                            |
                                            <a href="{{ url('delete-product-trash/'.$encrypted) }}" title="Delete Trash" class="ml-1 badge badge-pill text-white px-2 py-1 bg-gradient-danger">
