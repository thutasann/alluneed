    ...
    <div class="container-fluid mt-5">
        ...
        <div class="card mb-4 shadow-sm bg-gray-100 border-left-primary">
            <div class="card-body d-sm-flex align-items-center justify-content-between">
                <h6>
                    <a href="{{ url('sub-category')}}">Sub Categories (Brands)</a> 
                ...
                <span>
                    ...
                    @else
                        <a href="{{ url('empty-subcategory-trash') }}" class='btn btn-sm bg-gradient-danger p-1 text-white'>
            ...
            <div class='col-md-12'>
               <div class='card shadow-sm mb-4'>
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-gray-600">Sub Categories (Brands) Trash Table</h6>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($subcategory as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url('subcategory-re-store/' .$encrypted) }}" title="Restore" class="mr-1 badge badge-pill text-white px-2 py-1 bg-gradient-success">
                                                    <i class="fas fa-trash-restore-alt"></i>
                                                </a>
                                                <a href="{{ url('delete-subcategory-trash/'.$encrypted) }}" title="Delete Trash" class="badge badge-pill text-white px-2 py-1 bg-gradient-danger">
