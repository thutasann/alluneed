        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 mb-4 px-4">
                    ...
                    <p class='text-muted font-weight-bolder mb-4 mt-3'>You can Edit your Info below.</p>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-1">
                                    ...
                                    <div class="form-group focused">
                                        <textarea name=""  rows="4" class="form-control form-control-alternative" placeholder="Leave Here" spellcheck="false">
                                        </textarea>
                                    </div>
                                </div>
                ...
                <div class="col-lg-6 px-4">
                    ...
                    <div class="p-1">
                        <p class="font-italic mb-4 mt-3 font-weight-bolder">
                        ...
                        <div class="input-group mb-4 border rounded-pill p-1">
                            <input type="text" name="coupon_code" placeholder="Enter coupon code" class="coupon_code form-control border-0">
