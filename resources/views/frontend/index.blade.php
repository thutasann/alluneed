              ...
              <div class="col-6 col-sm-4 col-md-3 col-xl-2 text-center infi-item">
                  <div class='infi-dtl rounded waves-effect'>
                    <a href="{{url('collection/'.$i->subcategory->category->group->url.'/'.$i->subcategory->category->url.'/'.$i->subcategory->url.'/'.$i->url.'/'.Crypt::encrypt($i->id)) }}">
                      <img class="d-block mx-auto img-fluid mb-3 animated fadeIn" src="{{ asset('uploads/products/'.$i->prod_image)}}">
                      <hr>
                      <span class="infi-name animated fadeIn">{{$i->name}}</span>
                    </a>
                  </div>
              </div>
            @endforeach
  ...
  <div class="container-fluid">
    <div class="services-outer rounded">
      ...
      <nav class="services responsive-wrapper">
        ...
        <div class="banner-search ">
            <input type="search" placeholder="Search Categories..." id="myInput_hcate" class="rounded  banner-search-input" onkeyup="hcateFunction()" />
        </div>

        <ul class="services-list" id="myUL_hcate">
      ...
      <div class="row">
          ...
          <div id="demo1" class="carousel slide slides" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active bg-white">
                <a href="{{url('collection/electronics-devices')}}"> 
        ...
        <div class="col-md-6">
          <div class="one-product-text">
            ...
            <a href="{{url('collection/electronics-devices')}}" class="btn text-white bg-gradient-primary waves-effect">Shop Now</a>
          </div>
        </div>
      </div>
    </div>
