...
<div class="nav-div sticky-top">
  
  <!-- first nav -->
  <nav class="navbar first-nav sticky-top shadow-none">
        <div class="container-fluid">
          ...
          <span title="Delivery Address According to your IP Address" class='d-none d-md-block ml-3'>Delliver to <i class="fas fa-map-marker-alt"></i><br>
          ...
          <ul class="navbar-nav ml-auto nav-flex-icons text-dark">
            ...
            @guest
              ...
              <li class="nav-item font-weight-bolder">
                <a class="nav-link text-info waves-effect" href="{{ route('login') }}">Sign-In</a>
              </li>
              <span class="text-info ml-2 mr-2 mt-2">|</span>
              <li class="nav-item font-weight-bolder">
                <a class="nav-link text-info waves-effect" href="{{ route('register') }}"> Sign-Up</a>
              </li>
  ...
  <!-- sec nav  -->
  <nav class="navbar navbar-expand-lg navbar-light white sec-nav scrolling-navbar ">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav ml-auto mt-3 nav-flex-icons">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-xl-4 sub-menu mb-xl-0 mb-4">
                    ...
                    <ul class="list-unstyled" id="myUL_col">
                      @php
                        $group_nav = App\Models\Groups::where('status','!=','2')->get();
                      @endphp
                  ...
                  <div class="col-md-6 col-xl-4 sub-menu mb-xl-0 mb-4">
                    ...
                    <ul class="list-unstyled" id="myUL_cate">
                      @php
                        $cate_nav = App\Models\Category::where('status','!=','2')->get();
                      @endphp
                  ...
                  <div class="col-md-6 col-xl-4 sub-menu mb-xl-0 mb-4">
                    ...
                    <ul class="list-unstyled" id="myUL_brd">
                      @php
                        $brand_nav = App\Models\Subcategory::where('status','!=','2')->get();
                      @endphp
...
{{-- @php
  $groups = App\Models\Groups::where('status','!=','2')->get();
@endphp
