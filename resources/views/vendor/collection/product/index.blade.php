        ...
        <div class="card mb-4 shadow-sm bg-gray-100 border-left-primary">
            <div class="card-body d-sm-flex align-items-center justify-content-between">
                ...
                <span>
                    ...
                    <a href="{{ url('vendor/product-deleted-records') }}" class='btn btn-sm bg-gradient-danger p-1 text-white'>
                            ...
                            <table class='table table-striped table-bordered' id='datatable'>
                                ...
                                <tbody>
                                    @foreach ($products as $item)
                                        ...
                                        <td>
                                            <a href="{{ url('vendor/product-edit/'.$encrypted.'/'.$slname )}}" title="Edit" class="mr-1 badge badge-pill text-white px-2 py-1 bg-gradient-primary">
