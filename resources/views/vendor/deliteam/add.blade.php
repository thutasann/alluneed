            ...
            <div class='col-md-12'>
                <div class='card shadow-sm mb-4'>
                        <div class='card-body'>
                            ...
                            <form action="{{ url('vendor/shipping-team-store') }}" method="POST">
                                {{ csrf_field() }}
                                <div class='row'>
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <label>Email</label>
                                            <input type="email" name="email" id="form-autocomplete-country" class='form-control' placeholder='Enter Email' required>
                                        </div>
                                    </div>
                                    ...
                                    <div class='col-md-6'>
                                        <div class="form-group">
                                            <label>Phone</label>
                                            <input type="number" name="phone" class='form-control' placeholder='Enter Phone Number' value="" required>
                                        </div>
                                    </div>
